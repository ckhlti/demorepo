...
public class JumbotronModel {
	...
	private static final Logger LOG = LoggerFactory.getLogger(JumbotronModel.class);
    ...
    @ValueMapValue 
    private String bgFileReference;
    ...
    protected void init() {
        if (StringUtils.isEmpty(componentId) && currentResource != null) {
			...
			componentId = GlobalUtil.generateUniqueHashId("Custom-Jumbotron", currentResource.getPath()); 	//Generate unique component Id
    ...
    public String getBgFileReference(){
        return bgFileReference;
    }
}
