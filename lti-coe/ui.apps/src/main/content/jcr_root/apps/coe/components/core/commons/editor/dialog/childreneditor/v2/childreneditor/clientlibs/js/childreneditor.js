...
(function($, ns, channel, window) {
    ...
    var POST_SUFFIX = ".customcontainer.html";
    ...
    ChildrenEditor.prototype = (function() {
        ...
        return {
            ...
            update: function() {
                ...
                var removeSkipSlideProperty = this._processChildren(true);
                ...
                return $.ajax({
                    ...
                    data: {
                        ...
                        "removeSkipSlideProperty": removeSkipSlideProperty
                    }
                });
            },
             ...
             * @private
             */
            _processChildren: function(removeSkipSlideProperty) {
                this._orderedChildren = [];
                ...
                for (var i = 0; i < items.length; i++) {
                    ...
                    if(items[i].children[0].children[0].children[2]._checked){
                    	removeSkipSlideProperty = false;
                    }
                }
                
                return removeSkipSlideProperty;
            }
        };
    })();
